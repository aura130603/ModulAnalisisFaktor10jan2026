...
//                 // Extract label and data from tuple or object
//                 const [blockLabel, blockData] = Array.isArray(block) ? block : [block.matrix_type || "Total", block];

//                 if (!blockData || !blockData.initial || !blockData.initial.rows) {
//                     console.warn("Skipping invalid total_variance_explained block", block);
//                     return;
//                 }
...
//                 // Add extraction columns if data exists
...
//                 // Add rotation columns if data exists
