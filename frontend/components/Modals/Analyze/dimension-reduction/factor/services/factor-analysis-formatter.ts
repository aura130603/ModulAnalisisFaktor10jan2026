...
import {ResultJson, Table} from "@/types/Table";
    ...
    //     // --- PERBAIKAN: HANYA TAMPILKAN HEADER JIKA DATA ADA ---
    ...
    //         // --- PERBAIKAN: HANYA ISI NILAI JIKA DATA DI MAP ADA ---
    //         // Jangan pakai default (?? null) yang akan jadi 0
    //         if (hasExtractionData) {
    //             const extractionValue = extractionMap.get(variable);
    //             if (extractionValue !== undefined) {
    //                 rowData.extraction = formatDisplayNumber(extractionValue);
    //             }
    //         }
    //         // -------------------------------------------------------
    ...
    //     const noteRow: any = {
    //         rowHeader: [`Extraction Method: ${data.extraction_method || 'Maximum Likelihood'}.`], 
    //     };
